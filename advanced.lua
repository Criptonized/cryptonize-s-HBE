-- FurryHBE plugin: Advanced (radar/minimap + movement + persistence + auto-soften)
...
return {
	...
	load = function(ctx)
		...
		rg.Name = "FurryHBE_Radar"; rg.ResetOnSpawn = false; rg.IgnoreGuiInset = true; rg.DisplayOrder = 20; rg.Parent = parent
