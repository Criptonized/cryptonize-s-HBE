-- CryptsHBE plugin: Aimbot (camera aimbot + triggerbot + no-recoil)
...
return {
	...
	load = function(ctx)
		...
		howGroup:AddLabel(
			"AIMBOT (camera): drags your camera\n" ..
			"onto the closest enemy in the FOV cone.\n" ..
			"  1. Activate: Hold RMB / Key / Always.\n" ..
			"  2. Set Target Part, FOV, Smoothness\n" ..
			"     (low = slow/legit, 1 = snap).\n" ..
			"  3. 'Visible Only' skips wall enemies.\n" ..
			"     'Ballistic Prediction' leads movers\n" ..
			"     -- set Bullet Speed to the gun's.\n\n" ..
			"TRIGGERBOT: auto-fires when your\n" ..
			"crosshair is already on an enemy. Set\n" ..
			"Activate + Delay (ms) so it isn't instant.\n\n" ..
			"NO-RECOIL: zeroes recoil/spread values\n" ..
			"on the held gun (client-side only; if\n" ..
			"'Recoil values' stays 0 it's server-side).\n\n" ..
			"EXAMPLE: Hold RMB, Head, FOV 120,\n" ..
			"Smooth 0.25, Visible Only ON -> smooth,\n" ..
			"fairly legit aim while you hold RMB.",
			true)
	end,
