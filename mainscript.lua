...
pcall(function()
	...
	local PG_KEYS = {
		...
		"radarEnabled","radarRange","radarSize","bhopEnabled","infJumpEnabled","autoSoften","persistEnabled","persistUrl",
			...
			"dotEspEnabled","dotEspAllies","dotEspEnemies","dotEspTeamColor","dotEspSize","dotEspHeight","dotEspDist","dotEspDynamic","dotEspMaxScale",
...
pcall(function()
	...
	-- Remote (remotereplay) MERGED into RemoteSpy (2026-06-19): now the "Manual Replay (no capture)" groupbox on the "Spy" tab.
	...
	-- RemoteSniffer MERGED into RemoteSpy (2026-06-19): its combat-only filter, auto-replay, retarget + save-capture-log now live on the "Spy" tab.
