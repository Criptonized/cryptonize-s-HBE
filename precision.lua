...
return {
	...
	load = function(ctx)
		...
		howGroup:AddLabel(
			"Precision HBE enlarges ONE target's hitbox (not everyone) so your shots/melee connect\n" ..
			"more easily. Works even with the Main tab's Master Toggle off.\n\n" ..
			"  1. Enable Precision HBE.\n" ..
			"  2. Leave 'Auto-Select Target' on + pick a Resolver (Closest to Crosshair / Distance /\n" ..
			"     Lowest Health), or turn it off and press the Cycle Target key (default T).\n" ..
			"  3. Set Base Hitbox Size + Parts to Extend.\n\n" ..
			"KEEP 'Parts to Extend' on Head/Torso -- extending HumanoidRootPart FREEZES the target on\n" ..
			"your screen (the Info box warns [FROZEN?]). Dynamic Scaling grows the box at range;\n" ..
			"Transparency 1 = invisible hitbox. Save/Load Config persists your setup.",
			true)
