-- FurryHBE plugin: Silent Aim (hook-free Remote mode + Extreme namecall-hook mode)
-- ============================================================================
...
return {
	...
	load = function(ctx)
		...
		howGroup:AddLabel(
			"Silent aim = bullets hit the target without your camera moving. BOTH methods need\n" ..
			"the game's DAMAGE remote.\n\n" ..
			"SETUP:\n" ..
			"  1. Refresh Remotes, then pick the gun's damage RemoteEvent.\n" ..
			"  2. Set Argument/Redirect to match it (Character / Part / Position / Aim Direction).\n" ..
			"  3. Tune Bone, FOV, Priority, Max Distance, Hit Chance, LOS.\n\n" ..
			"REMOTE (hook-free, detection-safe): YOU fire that remote at the FOV target. Set\n" ..
			"  'Fire When' (Hold LMB/RMB/Always) + Fire Rate.\n\n" ..
			"HOOK (Extreme, detectable): flip 'Enable Hooks' to redirect the game's OWN shot to the\n" ..
			"  target's bone. Set Redirect to match the remote. Scoped to the one remote you picked.\n\n" ..
			"Don't know the remote? Calibrate -> Deep-Dump Held Weapon lists the gun's remotes.\n" ..
			"Wallbang = turn Line of Sight Check OFF. Raycast-hit games can't be silent-aimed here.",
			true)
