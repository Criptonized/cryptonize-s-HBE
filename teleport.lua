-- CryptsHBE plugin: Teleport (waypoints, teleport-to-player, seat teleport, anti-rubberband)
...
return {
	...
	-- Keep waypoints with the rest of the script's files in workspace/CryptsHBE/.
