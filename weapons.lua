...
return {
	...
	load = function(ctx)
		...
		g3:AddToggle("weaponAutoFire", { Text = "Auto-Fire (universal)", Default = false, Tooltip = "Rapid-clicks at the RPM below so a semi/bolt/pump gun fires full-auto.\nWorks on games that fire per click client-side. Bind a key to this\ntoggle in the menu so you can hold-to-spray. (Default: OFF)" }); C("weaponAutoFire")
